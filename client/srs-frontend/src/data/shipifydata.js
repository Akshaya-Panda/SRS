...
import dashboard2 from "../images/mainship.jpg";
import memoryimg from "../images/ship2.png";
...
export const hero = {
  "title": "Sea Beckons Beyond",
  "subtitle": "Embark and Explore",
  "text": "We always deliver your dream destinations. Count on us for a myriad of choices, ensuring your happiness",
  "btn1": "Login",
  "btn2": "About Us",
  "img": dashboard2,
};
...
export const memory = {
  ...
  "text": "What we have always taken care for 10 years is always prioritizing the comfort of our customers. So, do not our quality.",
  "img": memoryimg,
  "experience": [
    { "number": "10+", "title": " Year Service" },
    { "number": "400+", "title": "Locations" },
...
export const placesAPI = [
  ...
  { "placeImg": place2, "location": "Australia", "distance": "2.5 hour dirve" },
  { "placeImg": place3, "location": "Multan", "distance": "4.7 hour drive" },
  { "placeImg": place4, "location": "Singapore", "distance": "4 hour drive" },
  { "placeImg": place5, "location": "Islamabad", "distance": "4.9 hour drive" },
  { "placeImg": place6, "location": "Muree", "distance": "4.5 hour drive" },
  { "placeImg": place7, "location": "Saudi", "distance": "5.5 hour drive" },
...
export const bannerAPI = {
  ...
  "text": "Whislist Curated By Shipify.",
  "imgSrc": banner,
